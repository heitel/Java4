...
public class Bruch {
	...
	public Bruch mul(Bruch b) {
		...
		Bruch erg = new Bruch(zaehler * b.getZaehler(), nenner * b.getNenner());
		erg.kuerzen();
	...
	public Bruch div(Bruch b) {
		...
		Bruch erg = new Bruch(zaehler * b.getNenner(), nenner * b.getZaehler());
		erg.kuerzen();
	...
	private long ggTX(long z, long n) {
		z = Math.abs(z);
		n = Math.abs(n);
	...
	private static long ggT(long z1, long z2) {
		z1 = Math.abs(z1);
		z2 = Math.abs(z2);
	...
	private long kgV(long n1, long n2) {		
		return Math.abs(n1*n2)/ggT(n1,n2);
	}

	private long kgVX(long n1, long n2) {
