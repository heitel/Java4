...
public class SteuerelementeWinD extends JFrame implements ActionListener {
	private JButton button = new JButton("Bestellen");

	private JRadioButton schwarzwaelder = new JRadioButton(
	...
	private JComboBox<String> combo = new JComboBox<String>(new String[] {
			"Bar", "Scheck", "EC-Karte" });

	public SteuerelementeWinD(String title) {
		super(title);
		...
		combo.setBounds(220, 170, 100, 30);
		JLabel bez = new JLabel("Bezahlart:");
		bez.setBounds(140, 170, 100, 30);
	...
	public static void main(String[] args) {
		SteuerelementeWinD win = new SteuerelementeWinD("Test Controls");
